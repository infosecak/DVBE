...
Please feel free to contribute to the tool. The write up for the tool will be published once the tool is released publicly. The About.pdf might not open(for unknown reasons), try using the pptx or txt file.
